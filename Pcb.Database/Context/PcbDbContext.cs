	...
	public partial class PcbDbContext : DbContext
	{
		...
		protected override void OnModelCreating(ModelBuilder modelBuilder)
		{
			...
			modelBuilder.Entity<IngredientFoodGroup>().HasData(
				...
				new IngredientFoodGroup() { Id = 9, Title = "Fats and Oils" },
				new IngredientFoodGroup() { Id = 10, Title = "Fish" },
				new IngredientFoodGroup() { Id = 11, Title = "Fruits" },
				new IngredientFoodGroup() { Id = 12, Title = "Grains and Pasta" },
				...
				new IngredientFoodGroup() { Id = 19, Title = "Soups and Sauces" },
				new IngredientFoodGroup() { Id = 20, Title = "Spices and Herbs" },
				new IngredientFoodGroup() { Id = 21, Title = "Sweets" },
				new IngredientFoodGroup() { Id = 22, Title = "Vegetables" }
			);
