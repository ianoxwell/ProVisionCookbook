...
namespace Pcb.Database.Migrations
{
    ...
    [Migration("20201020214125_UserAccountAdditions")]
    partial class UserAccountAdditions
    {
            ...
            modelBuilder.Entity("Pcb.Database.Context.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            PasswordHash = "$2a$11$97X6/vEUsoqUfKctpk0aPeUnQ7V.dVLUpmsfl/IfYco1EbuTPucXu",
                            TimesLoggedIn = 0,
                            Username = "admin",
