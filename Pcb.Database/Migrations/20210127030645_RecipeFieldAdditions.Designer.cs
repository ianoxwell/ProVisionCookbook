...
namespace Pcb.Database.Migrations
{
    ...
    [Migration("20210127030645_RecipeFieldAdditions")]
    partial class RecipeFieldAdditions
    {
            ...
            modelBuilder.Entity("Pcb.Database.Context.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            PasswordHash = "$2a$11$XaXlI07k/IZTCijnq.qh4eAxWTZc50.UF1isNFcye6wOzI4Kf3gfC",
                            TimesLoggedIn = 0,
                            Username = "admin",
