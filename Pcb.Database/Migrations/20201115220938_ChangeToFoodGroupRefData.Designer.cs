...
namespace Pcb.Database.Migrations
{
    ...
    [Migration("20201115220938_ChangeToFoodGroupRefData")]
    partial class ChangeToFoodGroupRefData
    {
            ...
            modelBuilder.Entity("Pcb.Database.Context.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            PasswordHash = "$2a$11$DUv80uHd614LIHQS8zcA0uRsDwWTontbJ7wKXG6vuTtHuSMr3W/ZC",
                            TimesLoggedIn = 0,
                            Username = "admin",
