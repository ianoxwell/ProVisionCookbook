...
namespace Pcb.Database.Migrations
{
    ...
    [Migration("20210124221848_ConversionPreference")]
    partial class ConversionPreference
    {
            ...
            modelBuilder.Entity("Pcb.Database.Context.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            PasswordHash = "$2a$11$5gaoKRK34WTxZOHr24kPYu7xYRqnlRaM/PS1JcsG8QeewMcx2VN1q",
                            TimesLoggedIn = 0,
                            Username = "admin",
