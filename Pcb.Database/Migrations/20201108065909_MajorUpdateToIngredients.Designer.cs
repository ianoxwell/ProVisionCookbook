...
namespace Pcb.Database.Migrations
{
    ...
    [Migration("20201108065909_MajorUpdateToIngredients")]
    partial class MajorUpdateToIngredients
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Pcb.Database.Context.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            PasswordHash = "$2a$11$NcDi3uTJRNQlelpne5POfO3gbjBeidCPW182TT4gPX8lE5/ahPSyW",
                            TimesLoggedIn = 0,
                            Username = "admin",
            ...
            modelBuilder.Entity("Pcb.Database.Context.Models.Ingredient", b =>
                {
                    b.HasOne("Pcb.Database.Context.Models.IngredientParentType", "FoodGroup")
                        .WithMany("Ingredient")
