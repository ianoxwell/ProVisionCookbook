...
namespace Pcb.Database.Migrations
{
    ...
    [Migration("20201116002826_IngredientNullablePurchasedBy")]
    partial class IngredientNullablePurchasedBy
    {
            ...
            modelBuilder.Entity("Pcb.Database.Context.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            PasswordHash = "$2a$11$5QZGWpWTCePRm7Gutj6Tw.ijA7waIaoGd6/w/EBJBUaTSE2AfNpHC",
                            TimesLoggedIn = 0,
                            Username = "admin",
