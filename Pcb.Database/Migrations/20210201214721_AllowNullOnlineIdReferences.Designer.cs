...
namespace Pcb.Database.Migrations
{
    ...
    [Migration("20210201214721_AllowNullOnlineIdReferences")]
    partial class AllowNullOnlineIdReferences
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EquipmentRecipeSteppedInstruction", b =>
                {
                    b.Property<int>("EquipmentId")
                        .HasColumnType("int");

                    b.Property<int>("RecipeSteppedInstructionId")
                        .HasColumnType("int");

                    b.HasKey("EquipmentId", "RecipeSteppedInstructionId");

                    b.HasIndex("RecipeSteppedInstructionId");

                    b.ToTable("EquipmentRecipeSteppedInstruction");
                });
            ...
            modelBuilder.Entity("Pcb.Database.Context.Models.Equipment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Pcb.Database.Context.Models.Recipe", b =>
                {
                    ...
                    b.Property<string>("SourceOfRecipeName")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Pcb.Database.Context.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            PasswordHash = "$2a$11$UHpxOawOv.5PmlsODbxVtucI3YuswX/9.7TuX585RHEmGOzsFi8My",
                            TimesLoggedIn = 0,
                            Username = "admin",
            ...
            modelBuilder.Entity("EquipmentRecipeSteppedInstruction", b =>
                {
                    b.HasOne("Pcb.Database.Context.Models.Equipment", null)
                        .WithMany()
                        .HasForeignKey("EquipmentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Pcb.Database.Context.Models.RecipeSteppedInstruction", null)
                        .WithMany()
                        .HasForeignKey("RecipeSteppedInstructionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("Pcb.Database.Context.Models.IngredientConversion", b =>
                {
                    ...
                    b.Navigation("IngredientBaseConversionState");

                    b.Navigation("IngredientConvertConversionState");

                    b.Navigation("MeasurementBaseUnit");

                    b.Navigation("MeasurementConvertUnit");
                });
            ...
            modelBuilder.Entity("Pcb.Database.Context.Models.AllergyWarning", b =>
                {
                    b.Navigation("IngredientAllergyWarning");

                    b.Navigation("RecipeAllergyWarning");
                });

            modelBuilder.Entity("Pcb.Database.Context.Models.CuisineType", b =>
                {
                    b.Navigation("RecipeCuisineType");
                });

            modelBuilder.Entity("Pcb.Database.Context.Models.DishTag", b =>
                {
                    b.Navigation("RecipeDishTag");
                });

            modelBuilder.Entity("Pcb.Database.Context.Models.DishType", b =>
                {
                    b.Navigation("RecipeDishType");
                });

            modelBuilder.Entity("Pcb.Database.Context.Models.HealthLabel", b =>
                {
                    b.Navigation("RecipeHealthLabel");
                });
            ...
            modelBuilder.Entity("Pcb.Database.Context.Models.Ingredient", b =>
                {
                    ...
                    b.Navigation("IngredientConversions");
            ...
            modelBuilder.Entity("Pcb.Database.Context.Models.IngredientState", b =>
                {
                    ...
                    b.Navigation("IngredientBaseConversions");
            ...
            modelBuilder.Entity("Pcb.Database.Context.Models.MeasurementUnit", b =>
                {
                    b.Navigation("MeasurementBaseUnits");

                    b.Navigation("MeasurementConvertUnits");
                });
            ...
            modelBuilder.Entity("Pcb.Database.Context.Models.Recipe", b =>
                {
                    ...
                    b.Navigation("RecipePicture");

                    b.Navigation("RecipeReview");

                    b.Navigation("SteppedInstruction");
                });
